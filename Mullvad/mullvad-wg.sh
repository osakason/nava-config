...
read -p "Type which server location you wish to use: " SERVER_LOCATION

wg-quick up mullvad-$SERVER_LOCATION

echo "Check to see if we are indeed connected to the server by visiting https://mullvad.net/en/check/"
